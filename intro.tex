...
\begin{document}
	...
	\begin{frame}{Czym jest PCA?}
		...
		\begin{itemize}
			...
			\item \textbf{Usunięcie Korelacji:} Zamienia zbiór skorelowanych zmiennych w nową -- liniowo niezależną bazę składającą się z wektorów nazywanych \textit{głównymi składowymi}.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Intuicja}
		...
		\begin{enumerate}
			...
			\item Ten proces kontynuować można $n$ razy, usuwając te składowe, które zachowują najmniej wariancji, upraszczając i kompresując w ten sposób dane.
		\end{enumerate}
	\end{frame}
